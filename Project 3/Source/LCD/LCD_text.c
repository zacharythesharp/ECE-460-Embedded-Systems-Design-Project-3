...
// ROM Size Reduction: only include name(s) of fonts to use here!
const uint8_t * fonts[] = {0, Lucida_Console12x19, 0}; 
// const uint8_t * fonts[] = {Lucida_Console8x13, Lucida_Console12x19, Lucida_Console20x31}; // Full font set
